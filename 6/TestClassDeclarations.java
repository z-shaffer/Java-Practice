...
* @version 03.30.2014 - modified 9/3/20
*/
...
public class TestClassDeclarations
{
    ...
    public void checkDog()
    {
        ...
        printHeader();        
        checkClass();   
        checkFieldNumber(3, 3);   
        checkFields();
        checkConstructor("String", "int", "String");
        checkConstructor();
        checkMutators();
        checkAccessors();
        checkMethod("bark", "String");
        checkMethod("bark", "String", "String");
        checkMethod("increaseAge", "void");
        checkMethod("toString", "String");
        checkMethod("equals", "boolean", "Dog");
        ...
        if(fail)
        {
            fail("Fail: Check terminal for details");
        }
    }
